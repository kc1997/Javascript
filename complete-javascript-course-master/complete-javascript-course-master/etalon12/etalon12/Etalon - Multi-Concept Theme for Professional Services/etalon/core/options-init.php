            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'title' => esc_html__('Secondary theme color', 'etalon'),
                        'default' => '#ffffff',
                        'validate' => 'color'
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'title' => esc_html__('Contact Form name', 'etalon'),
                        'required' => array('tek-header-button-action','equals','1'),
                        'default' => ''
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                                'id' => 'tek-woo-support',
                                'type' => 'switch',
                                'title' => esc_html__('WooCommerce Support', 'etalon'),
                                'subtitle' => esc_html__('Please install and activate WooCommerce before activating this option.', 'etalon'),
                                'default' => '0',
                                'on' => 'Yes',
                                'off' => 'No',
                        ),
